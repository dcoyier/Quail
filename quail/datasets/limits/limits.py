...
# Menus dish pack: ~1.33M rows / ~200MB+ CSV / tens of M cells / multi-GiB
# durable estimate. Raised on this branch for that corpus.
MAX_CSV_BYTES = 512 * 1024 * 1024
MAX_CSV_ROWS = 2_000_000
MAX_DATASET_FIELDS = 1_024
MAX_DATASET_CELLS = 50_000_000
MAX_DATASET_DURABLE_BYTES = 8 * 1024 * 1024 * 1024
