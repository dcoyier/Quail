...
README owns installation and links to [uv installation](https://docs.astral.sh/uv/getting-started/installation/);
`USING_QUAIL.md` continues with the first study and analysis. The combined
path below must work without project inspection.
